...
root.iconbitmap(r"C:\Users\NIKHIL\Downloads\bitmap.ico")
...
lab = Label(root, width=25, height=2, text="", font=("arial", 30))
lab.pack()
...
Button(root, text="=", width=5, height=3, font=("arial", 30, "bold"), bd=1, fg="#fff", bg="#fe9037", command=evaluate).place(x=430, y=400)
